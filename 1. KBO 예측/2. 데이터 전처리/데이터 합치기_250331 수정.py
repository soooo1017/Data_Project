...
# 전체 데이터프레임 > 불필요 컬럼 삭제
team_df = team_df.drop(columns=['경기', '승', '패', '무', '게임차', '최근10경기', '연속', '홈', '방문'])
...
with pd.ExcelWriter("/Users/SOO/Desktop/데분 포트폴리오/Data_Project/1. KBO 예측/2. 데이터 전처리/(2차) 데이터 전처리 및 상관계수 결과/전처리_v4(연도 2001 삭제).xlsx") as writer:
