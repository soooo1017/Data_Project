...
# 데이터 로드
final_data = pd.read_excel('/Users/SOO/Desktop/데분 포트폴리오/Data_Project/1. KBO 예측/2. 데이터 전처리/최종 데이터 정리/Final_KBO_Data_v1.xlsx')
...
y_train = final_data[final_data['연도'] < 2024]['순위']

# 4. 테스트 데이터 (2024년 데이터로 2025년 예측)
X_test = final_data[final_data['연도'] == 2024][features]
y_test = final_data[final_data['연도'] == 2024]['순위']
...
# 11. 예측값 출력
final_data.loc[final_data['연도'] == 2024, '예측_순위'] = predictions
print(final_data[final_data['연도'] == 2024][['팀명', '연도', '예측_순위', '순위']])
