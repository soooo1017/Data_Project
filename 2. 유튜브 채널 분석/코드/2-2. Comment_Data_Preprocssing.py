...
comment_df = pd.read_csv('../1. Data_Collection/(2025-05-09_031814)ssglanders_video_comments.csv')
...
print(pd.merge(comment_df, video_final_df, on='video_id', how='left').head())
...
comment_final_df['video_id_label'] = pd.merge(comment_df, video_final_df, on='video_id', how='left')['id']
